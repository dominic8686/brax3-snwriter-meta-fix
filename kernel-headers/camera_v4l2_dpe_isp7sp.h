...
struct DPE_Config_V2 {
	...
	unsigned int Dpe_InBuf_SrcImg_Y_Pre;
	unsigned int Dpe_InBuf_SrcImg_C_Pre;
	...
	unsigned int Dpe_OutBuf_OCC_Hist;
	unsigned int Dpe_InBuf_OCC;
	unsigned int Dpe_InBuf_OCC_Ext;
	unsigned int Dpe_OutBuf_CRM;
	unsigned int Dpe_OutBuf_WMF_RD;
	unsigned int Dpe_OutBuf_WMF_RD_Ext;
	...
	unsigned int Dpe_OutBuf_WT_Fnl;
	unsigned int Dpe_OutBuf_RW_IIR;
