...
#define V4L2_PIX_FMT_MTISP_PLANAR_BGGR_8  v4l2_fourcc('M', 'T', '8', 'B')   /* MTK 4 plane RGB, 8bit, BGGR */
...
#define V4L2_PIX_FMT_MTISP_PLANAR_BGGR_10  v4l2_fourcc('M', 'T', 'A', 'B')  /* MTK 4 plane RGB, 10bit, BGGR */
...
#define V4L2_PIX_FMT_MTISP_PLANAR_BGGR_12  v4l2_fourcc('M', 'T', 'C', 'B')  /* MTK 4 plane RGB, 12bit, BGGR */
...
#define V4L2_PIX_FMT_MTISP_PLANAR_BGGR_10P  v4l2_fourcc('M', 'T', 'a', 'B') /* MTK 4 plane RGB Packed, 10bit, BGGR */
...
#define V4L2_PIX_FMT_MTISP_PLANAR_BGGR_12P  v4l2_fourcc('M', 'T', 'c', 'B') /* MTK 4 plane RGB Packed, 12bit, BGGR */
