...
#define V4L2_CID_FRAME_SYNC (V4L2_CID_USER_MTK_SENSOR_1ST_BASE + 1)
#define V4L2_CID_FSYNC_ASYNC_MASTER (V4L2_CID_USER_MTK_SENSOR_1ST_BASE + 2)
#define V4L2_CID_MTK_MSTREAM_MODE (V4L2_CID_USER_MTK_SENSOR_1ST_BASE + 3)
#define V4L2_CID_MTK_N_1_MODE (V4L2_CID_USER_MTK_SENSOR_1ST_BASE + 4)
...
#define V4L2_CID_MTK_MAX_FPS (V4L2_CID_USER_MTK_SENSOR_BASE + 13)
#define V4L2_CID_MTK_STAGGER_AE_CTRL (V4L2_CID_USER_MTK_SENSOR_BASE + 14)
#define V4L2_CID_SEAMLESS_SCENARIOS (V4L2_CID_USER_MTK_SENSOR_BASE + 15)
#define V4L2_CID_MTK_STAGGER_INFO (V4L2_CID_USER_MTK_SENSOR_BASE + 16)
#define V4L2_CID_STAGGER_TARGET_SCENARIO (V4L2_CID_USER_MTK_SENSOR_BASE + 17)
#define V4L2_CID_START_SEAMLESS_SWITCH (V4L2_CID_USER_MTK_SENSOR_BASE + 18)
#define V4L2_CID_MTK_DEBUG_CMD (V4L2_CID_USER_MTK_SENSOR_BASE + 19)
#define V4L2_CID_MAX_EXP_TIME (V4L2_CID_USER_MTK_SENSOR_BASE + 20)
#define V4L2_CID_MTK_SENSOR_PIXEL_RATE (V4L2_CID_USER_MTK_SENSOR_BASE + 21)
#define V4L2_CID_MTK_FRAME_DESC (V4L2_CID_USER_MTK_SENSOR_BASE + 22)
#define V4L2_CID_MTK_SENSOR_STATIC_PARAM (V4L2_CID_USER_MTK_SENSOR_BASE + 23)
#define V4L2_CID_MTK_SENSOR_POWER (V4L2_CID_USER_MTK_SENSOR_BASE + 24)
#define V4L2_CID_MTK_CUST_SENSOR_PIXEL_RATE (V4L2_CID_USER_MTK_SENSOR_BASE + 25)
#define V4L2_CID_MTK_CSI_PARAM (V4L2_CID_USER_MTK_SENSOR_BASE + 26)
#define V4L2_CID_MTK_SENSOR_TEST_PATTERN_DATA (V4L2_CID_USER_MTK_SENSOR_BASE + 27)
#define V4L2_CID_MTK_SENSOR_RESET (V4L2_CID_USER_MTK_SENSOR_BASE + 28)
#define V4L2_CID_MTK_SENSOR_INIT (V4L2_CID_USER_MTK_SENSOR_BASE + 29)
#define V4L2_CID_MTK_SOF_TIMEOUT_VALUE (V4L2_CID_USER_MTK_SENSOR_BASE + 30)
#define V4L2_CID_MTK_SENSOR_RESET_S_STREAM (V4L2_CID_USER_MTK_SENSOR_BASE + 31)
#define V4L2_CID_MTK_SENSOR_RESET_BY_USER (V4L2_CID_USER_MTK_SENSOR_BASE + 32)
#define V4L2_CID_MTK_SENSOR_IDX (V4L2_CID_USER_MTK_SENSOR_BASE + 33)
#define V4L2_CID_MTK_AOV_SWITCH_I2C_BUS_SCL_AUX (V4L2_CID_USER_MTK_SENSOR_BASE + 34)
#define V4L2_CID_MTK_AOV_SWITCH_I2C_BUS_SDA_AUX (V4L2_CID_USER_MTK_SENSOR_BASE + 35)
#define V4L2_CID_MTK_AOV_SWITCH_RX_PARAM (V4L2_CID_USER_MTK_SENSOR_BASE + 36)
#define V4L2_CID_MTK_AOV_SWITCH_PM_OPS (V4L2_CID_USER_MTK_SENSOR_BASE + 37)
#define V4L2_CID_MTK_AOV_SWITCH_MCLK_ULPOSC (V4L2_CID_USER_MTK_SENSOR_BASE + 38)
...
#define V4L2_CMD_FSYNC_SYNC_FRAME_START_END (V4L2_CMD_USER_MTK_SENSOR_BASE + 1)
#define V4L2_CID_MTK_SENINF_S_STREAM (V4L2_CID_USER_MTK_SENINF_BASE + 1)
#define V4L2_CID_FSYNC_MAP_ID (V4L2_CID_USER_MTK_SENINF_BASE + 2)
#define V4L2_CID_VSYNC_NOTIFY (V4L2_CID_USER_MTK_SENINF_BASE + 3)
#define V4L2_CID_TEST_PATTERN_FOR_AOV_PARAM (V4L2_CID_USER_MTK_SENINF_BASE + 4)
#define V4L2_CID_FSYNC_LISTEN_TARGET (V4L2_CID_USER_MTK_SENINF_BASE + 5)
#define V4L2_CID_REAL_SENSOR_FOR_AOV_PARAM (V4L2_CID_USER_MTK_SENINF_BASE + 6)
#define V4L2_CID_UPDATE_SOF_CNT (V4L2_CID_USER_MTK_SENINF_BASE + 7)
