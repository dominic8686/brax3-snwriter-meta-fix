...
PRODUCT_VENDOR_PROPERTIES += \
    ...
    persist.log.tag.PQ_HDR=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.libMEOW=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.ccci_mdinit=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.flp=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.MNLD=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.md_thermal=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.SecHAL=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.TlcKM=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.TeeEndorsementInstaller=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.TeeMcDaemon=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.TeeSysClient=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.libnfc_nci=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.audio_sw_mixer=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.aurisys_lib_handler=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.aurisys_lib_manager=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.aurisys_utility=$(VENDOR_LOG_LEVEL) \
